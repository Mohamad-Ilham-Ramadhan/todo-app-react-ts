...
export default function List({children, id, completed} : Props) {
  ...
  return (
    <li className="group flex py-3.5 pr-3.5 sm:py-5 sm:pr-5 dark:text-dark-theme-light-grayish-blue text-light-theme-very-dark-grayish-blue border-b last:border-b-0 dark:border-dark-theme-darkest-grayish-blue border-light-theme-very-light-grayish-blue">
      ...
      <button className="flex sm:hidden sm:group-hover:flex justify-center items-center ml-auto focus:outline-none" onClick={() => handleRemove(id)}>
